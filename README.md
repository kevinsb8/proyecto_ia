...
## Asistente IA Groq (modo ahorro)

La página **Asistente IA** incluye consejos locales, botón de sugerencias, chat y generación de informe. El proyecto usa por defecto `llama-3.1-8b-instant`, contexto reducido y caché para disminuir consumo de tokens. Lee `LEEME-IA-GROQ.txt` antes de agregar la clave.
